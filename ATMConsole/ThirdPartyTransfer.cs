...
{
    class ThirdPartyTransfer : Transaction
    {
        ...
        public ThirdPartyTransfer(Int64 accountNoFrom, Int64 accountNoTo, decimal transaction_amt)
        {
            _transactionId = 1;
            _banckAccountNoFrom = accountNoFrom;
            _banckAccountNoTo = accountNoTo;
            _transactionType = TransactionType.ThirdPartyTransfer;
        ...
        public Transaction PerformThirdPartyTransfer() 
        { 
            return null;
        }
